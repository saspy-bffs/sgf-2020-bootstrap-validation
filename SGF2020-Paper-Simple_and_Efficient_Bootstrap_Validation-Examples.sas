...
Example File for Invited Paper -- SAS Global Forum 2020

This file contains an executable version of the running example in the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation.
*/
...
**Note**: You may also wish to change the values of the macro variables in order to explore bootstrap validation for different models. The running example is adapted from Module 10 at https://wwwn.cdc.gov/nchs/nhanes/tutorials/samplecode.aspx
*/
...
See page 4 of the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation. Only PROC LOGISTIC output should be created.
*/
...
See page 5 of the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation. Only PROC SURVEYSELECT output should be created.
*/
proc surveyselect
        data=example_dataset
...
See page 6 of the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation. Only SAS log output should be created.
*/
...
See page 8 of the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation. Only SAS log output should be created.
*/
proc sql;
...
See page 9 of the paper at https://github.com/saspy-bffs/sgf-2020-bootstrap-validation. Only PROC PRINT output should be created.
*/
